...
config = FitConfig(
    # F1280W standard aperture, matching classic IDL subphot on Y. Asada's
    # MIRI catalog (see docs/campaigns.md).
    fit_astrometry_niter=2, fit_astrometry_joint=True, scene_minimum_anchors=10, aperture_diam=1.20
)
